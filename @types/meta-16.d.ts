...
/// <reference path="./clutter-16.d.ts" />
...
declare module 'gi://Meta?version=16' {
    ...
    import type Clutter from 'gi://Clutter?version=16';
    ...
    export namespace Meta {
        ...
        abstract class Backend extends GObject.Object implements Gio.Initable {
            ...
            connect(signal: 'resume', callback: (_source: this) => void): number;
            connect_after(signal: 'resume', callback: (_source: this) => void): number;
            emit(signal: 'resume'): void;
        ...
        class CursorTracker extends GObject.Object {
            ...
            connect(signal: 'cursor-prefs-changed', callback: (_source: this) => void): number;
            connect_after(signal: 'cursor-prefs-changed', callback: (_source: this) => void): number;
            emit(signal: 'cursor-prefs-changed'): void;
        ...
        class Display extends GObject.Object {
            ...
            connect_after(
                signal: 'focus-window',
                callback: (_source: this, object: Window, p0: number) => void,
            ): number;
            ...
            connect_after(
                ...
                callback: (_source: this, object: Window, p0: GrabOp) => void,
            ): number;
