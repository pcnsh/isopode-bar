...
declare module 'gi://Clutter?version=16' {
    // Module dependencies
    ...
    export namespace Clutter {
        ...
        class ColorState extends GObject.Object {
            ...
            vfunc_do_transform(target_color_state: ColorState, input: number, output: number, n_samples: number): void;
            ...
            vfunc_init_color_transform_key(target_color_state: ColorState, key: ColorTransformKey): void;
            ...
            do_transform(target_color_state: ColorState, input: number, output: number, n_samples: number): void;
        ...
        class Stage extends Actor implements Atk.ImplementorIface, Animatable {
            ...
            connect(signal: 'skipped-paint', callback: (_source: this, view: StageView, frame: Frame) => void): number;
            connect_after(
                signal: 'skipped-paint',
                callback: (_source: this, view: StageView, frame: Frame) => void,
            ): number;
            emit(signal: 'skipped-paint', view: StageView, frame: Frame): void;
...
declare module 'gi://Clutter' {
    import Clutter16 from 'gi://Clutter?version=16';
    export default Clutter16;
}
// END
